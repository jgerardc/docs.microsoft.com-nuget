...
#description: release notes <NuGet 1.1> (where <NuGet 1.1> matches what’s in the filename)
#keywords: release notes <NuGet 1.1> (where <NuGet 1.1> matches what’s in the filename)
#ROBOTS: 
#audience: 
#ms.devlang: 
ms.reviewer:  
